     ...
     <div className='flex flex-wrap justify-center items-center px-6 py-[130px] max-w-10xl mx-auto'>
        ...
        <div className='w-[100%] lg:w-[40%] md:w-[67%] lg:ml-20'>
          <form  onSubmit={onSubmit}>
            ...
            <p >Do Not have an Account? <a className='text-red-600' href="/sign-up">Register</a></p>
            <a className='text-red-600' href='/sign-in'>Sign in instead</a>
         </div>
         <button className='mb-4 mt-4 w-full text-lg bg-blue-600 text-white h-14 rounded-md  hover:bg-blue-700 shadow-lg active:bg-blue-800' type='submit'>Send Reset Mail</button>
