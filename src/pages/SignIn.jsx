...
export default function SignIn() {
 ...
 const [showPassword,setShowPassword]=useState(false);
  ...
  return (<section className='mt-6'> 
     <h1 className='text-3xl text-center mt-6  cursive'>Sign in</h1>
     <div className='flex flex-wrap justify-center items-center px-6 py-[130px] max-w-10xl mx-auto'>
        ...
        <div className='w-[100%] lg:w-[40%] md:w-[67%] lg:ml-20'>
          <form  onSubmit={onSubmit}>
            ...
            {showPassword ? 
            (<AiFillEye onClick={()=>{setShowPassword(!showPassword)}} className='absolute text-xl right-[10px] top-[82px]'/>) : 
            <AiFillEyeInvisible onClick={()=>{setShowPassword(!showPassword)}} className='absolute text-xl right-[10px] top-[82px]'/>}
            </div>
            <div className='flex justify-between text-lg mt-2 mb-8'>
            <p >Do Not have a Account? <a className='text-red-600' href="/sign-up">  Register</a></p>
            <a className='text-red-600' href='/forgot-password'>forgot password?</a>
         </div>
         <button className='mb-4 mt-4 w-full text-lg bg-blue-600 text-white h-14 rounded-md  hover:bg-blue-700 shadow-lg active:bg-blue-800' type='submit'>Sign In</button>
